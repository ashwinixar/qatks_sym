...
//E : (F_2)^m -> (F_2)^n, E is a boolean function which takes "m" bit string as input (plaintext) and produces "n" bit output (ciphertext)
//Here m = n = 8
...
{
	int m = 8; //Input size (in bits) of plaintext
    int n = 8; //Output size (in bits) of ciphertext
