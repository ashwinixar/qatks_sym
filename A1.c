...
int main (int narg, char *varg[])
{
    ...
    //Hence, Grover's iteration must be repeated for (pi/4)*(2^(h/2)) = (3.14/4)*(2^(5.415/2)) = 5.129 times or 5 times
    ...
    //So, times = (pi/4) * sqrt(2^n/m) = (3.14/4) * sqrt(256/6) = 5.128 or 5
    //The number of iterations same as the attack's requirement
    int times = 5;
